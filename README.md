...
* **Magíster en Ciencias de la Ingeniería Industrial** | Universidad Técnica Federico Santa María (GPA: 92/100).
* **Asistente de Investigación** en Proyecto Fondecyt Iniciación N°11250084, enfocado en el procesamiento de microdatos financieros internacionales, unión de olas de panel y estimación de modelos econométricos complejos.
* **Docencia:** Ayudante de asignaturas clave como *Análisis de Negocios (Machine Learning aplicado e Inteligencia de Negocios)* y *Probabilidad y Estadística*.
